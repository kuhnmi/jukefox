...
public interface IReadOnlyPlaylist {
	...
	List<PlaylistSong<BaseArtist, BaseAlbum>> getSongList();

	String getPlaylistName();

	int getPlaylistSize();

	PlaylistSong<BaseArtist, BaseAlbum> getSongAtPosition(int position) throws PlaylistPositionOutOfRangeException;
