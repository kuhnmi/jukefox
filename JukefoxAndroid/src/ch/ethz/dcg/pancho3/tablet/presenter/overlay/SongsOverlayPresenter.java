 ...
 */
public class SongsOverlayPresenter extends AbstractOverlayPresenter {

	// The albums about which we display information.
	private final List<BaseSong<BaseArtist, BaseAlbum>> songs;
	 ...
	 * to display.
	 */
	public SongsOverlayPresenter(TabletPresenter tabletPresenter,
	...
	public boolean onCreateActionMode(ActionMode mode, Menu menu) {
		actionMode = mode;
		mode.setTitle(i18nManager.getDisplayNumberOfSongsText(songs.size()));
		mode.setSubtitle("");
		this.menu = menu;
		return true;
	}
