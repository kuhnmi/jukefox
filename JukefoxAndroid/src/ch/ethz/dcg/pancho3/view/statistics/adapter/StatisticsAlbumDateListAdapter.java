...
/**
 * Same as {@link StatisticsDateListAdapter} but with an icon.
 * 
 * @see {@link StatisticsDateListAdapter}
 */
public class StatisticsAlbumDateListAdapter<T extends StatisticsAlbum> extends StatisticsDateListAdapter<T> {

	private final StatisticsAlbumIconHelper<T> albumIconHelper;

	public StatisticsAlbumDateListAdapter(Context context, List<T> data,
