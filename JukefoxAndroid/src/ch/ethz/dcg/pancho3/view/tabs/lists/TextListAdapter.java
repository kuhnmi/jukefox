...
public class TextListAdapter<ListType extends IBaseListItem> extends ArrayAdapter<ListType> {

	private int layoutId = 0;

	public TextListAdapter(Context context, int textViewResourceId, List<ListType> items) {
