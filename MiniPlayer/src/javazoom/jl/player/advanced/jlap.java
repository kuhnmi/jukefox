...
public class jlap
{
	...
	public static AdvancedPlayer playMp3(final InputStream is, final int start, final int end, PlaybackListener listener)
	...
	public class InfoListener implements PlaybackListener
	{
		...
		{
			System.out.println("Play stopped at frame " + evt.getFrame());
			System.exit(0);
		}
