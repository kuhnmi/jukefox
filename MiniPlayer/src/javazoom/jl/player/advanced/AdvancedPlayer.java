...
import ch.ethz.dcg.miniplayer.IPositionListener;
...
public class AdvancedPlayer {
	...
	public void playFromPosition() throws JavaLayerException {
		play(Integer.MAX_VALUE);
	}

	public boolean skipFrames(int num) throws JavaLayerException {
		boolean ret = true;
		int offset = num;
		while (offset-- > 0 && ret)
			ret = skipFrame();
	...
	/**
	 * sets the <code>PlaybackPositionListener</code>
	 */
	public void setPlayBackPositionListener(IPositionListener positionListener) {
	...
	public void playFrom(int position) throws JavaLayerException {
		play(position, Integer.MAX_VALUE);
	}
